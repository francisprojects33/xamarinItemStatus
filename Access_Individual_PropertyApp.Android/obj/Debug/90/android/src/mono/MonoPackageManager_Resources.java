...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Access_Individual_PropertyApp.Android.dll" comes first in this list. */
		"Access_Individual_PropertyApp.Android.dll",
		"Access_Individual_PropertyApp.dll",
		"FormsViewGroup.dll",
